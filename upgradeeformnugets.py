...
def main():
    ...
    if int(get_git_status()) > 0:
        ...
        os.chdir("Microting.WorkOrderBase")
        ...
        packages = [
            ...
            'Microsoft.EntityFrameworkCore.Tools', 'Microsoft.Extensions.DependencyInjection.Abstractions'
        ]
        process_repository('Microting.WorkOrderBase.csproj', packages, 'eform-workorder-base')
        ...
        if new_number_of_commits > current_number_of_commits:
            ...
            os.chdir("..")
            run_command(f"github_changelog_generator -u microting -p eform-workorder-base -t {os.getenv('CHANGELOG_GITHUB_TOKEN')}", shell=True)
