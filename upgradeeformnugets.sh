...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.WorkOrderBase/Microting.WorkOrderBase.csproj package Microting.eForm
	dotnet add Microting.WorkOrderBase/Microting.WorkOrderBase.csproj package Microting.eFormApi.BasePn
